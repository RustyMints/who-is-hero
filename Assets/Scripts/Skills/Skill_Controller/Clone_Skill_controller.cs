...
public class Clone_Skill_controller : MonoBehaviour
{
    ...
    public void SetupClone(Transform _newTransform,float _cloneDuration,bool _canAttack,Vector3 _offset,Transform _closesEnemy,bool _canDuplicate,float _chanceToDuplicate)
    {
        if (_canAttack)
